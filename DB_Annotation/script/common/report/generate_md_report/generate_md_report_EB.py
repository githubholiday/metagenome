...
def replace_template(md_json_dict, count, bool_local, project, bool_pdf, config, icon_dir):
    '''
...
def modify_content(a_line, inputs_dict, count, bool_local, project):
    ...
    if a_line.variable in inputs_dict:  
        ...
        raise Exception('{0} is not defined'.format(a_line.variable))
