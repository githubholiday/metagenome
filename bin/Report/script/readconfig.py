...
class TestConfig( unittest.TestCase ):
	def test_config( self ):
		config_file = '/annoroad/data1/bioinfo/PMO/tuchengfang/bin/Pipeline/NGS_QC_Pipeline/Pipeline_NGS_QC/v2.0.0/config/config_v2.ini'
		my_config = Config( config_file )
		value = my_config.get_value('pwd')
		print(value)
		#self.assertEquals(value, 'K8b#xx2^QcYs')
