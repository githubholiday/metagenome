...
pdf(opt$outfile,width = 7, height = 10)
...
text(x=-0.6,y=seq(1,1+(dim(data)[1]-1)*1.5,by=1.5), labels = data[,2],xpd = TRUE,adj=1,cex=0.5) #调整了字体大小
text(x=data[,4]+0.3,y=seq(1,1+(dim(data)[1]-1)*1.5,by=1.5),labels=data[,3],xpd=TRUE,adj=0,cex=0.4) #调整了字体大小
