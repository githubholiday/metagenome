...
print_usage <- function(spec=NULL){
  ...
  cat("
	...
	Usage example:
	Rscript KEGG_classificate_plot.r --infile /annoroad/data1/bioinfo/PMO/jiahan/script/KEGG_classificate.xls --outfile /annoroad/data1/bioinfo/PMO/jiahan/script/KEGG_classificate.pdf --title \"KEGG Classification\" --xlabel \"Percent of Genes(%)\" --type 1
		Options:
		...
		--type	ty	character	the color of picture [forced]
	\n")
	q(status=1)	
}
#===========================================================
