...
def main():
    ...
    title = 'Sample\tchemistry_target:resistance to chemical\tchemistry_target:sensitivity to chemical\teffector(plant avirulence determinant)\tincreased virulence(hypervirulence)\tlethal\tloss of pathogenicity\treduced virulence\tunaffected pathogenicity\n'
